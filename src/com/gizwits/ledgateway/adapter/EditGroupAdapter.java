...
import com.gizwits.ledgateway.activity.GroupActivity;
...
public class EditGroupAdapter extends BaseAdapter {   
    ...
    public EditGroupAdapter(GroupActivity context, Map<String, List<String>> mapList, List<String> list) { 
    	this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {   
        ...
        if (convertView == null) {   
            ...
            //获取list_item布局文件的视图   
            convertView = listContainer.inflate(R.layout.item_edit_list, null); 
            //获取控件对象   
        ...
        for (int i = 0; i < mapList.get(list.get(position)).size(); i++) {
            ...
            listItemView.tv.addView(textview); 
		}       
        return convertView;     
    }
